    ...
    public partial class LoginPage : ContentPage
    {
        ...
        private async void BtnSignIn_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    await DisplayAlert("Alerta", "Ingresa tu correo", "Ok");
                    return;
                }
                if (String.IsNullOrEmpty(password))
                {
                    await DisplayAlert("Alerta", "Ingresa tu contraseña", "Ok");
                    return;
                }
                ...
                {
                    await DisplayAlert("Inicio de sesion", "Inicio de sesion fallido", "ok");
                }
            }
